...
transform_task = GlueJobOperator(
    ...
    script_location='s3://aws-glue-assest/scripts/transform.py',
    s3_bucket='s3://aws-glue-assest',  # S3 bucket where logs and local etl script will be uploaded
    aws_conn_id='AWS_CONN',  # You'll need to set up an AWS connection in Airflow
    region_name="ap-south-1",
    iam_role_name='arn:aws:iam::590184023001:role/airflow-project',
