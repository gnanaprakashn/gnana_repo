...
weather_dyf = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://bepecairflowoutputtos3bucket1/raw/weather_api_data.csv"],
        "recurse": True,
    },
...
redshift_output = glueContext.write_dynamic_frame.from_options(
    ...
    connection_options={
        "redshiftTmpDir": "s3://aws-glue-assest/temporary/",
        "useConnectionProperties": "true",
        "aws_iam_role": "arn:aws:iam::590184023001:role/airflow-project",
